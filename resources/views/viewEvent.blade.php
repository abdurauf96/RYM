...
<div class="header-pages " style="background-image: url('/images/pages-bg.png');">
    <div class="rym-container">
        <h1 class="header-pages-title">{{ $event->getTranslatedAttribute('title', \App::getLocale()) }}</h1>
    </div>
    <div class="topic-header-social">
        <div class="topic-header-social-left">
            ...
            <div class="topic-header-social-left-item">
                ...
                <span class="likes_event_id">{{ $event->likes()->count() }} </span>
        ...
        <div class="topic-header-social-right">
            ...
            <ul class="footer-social-links">
                <li class="footer-social-links-item"><a href="https://www.facebook.com/sharer/sharer.php?u=http://rym.uz/event/{{ $event->slug  }}" class="footer-social-links-link"><svg width="13"
                ...
                <li class="footer-social-links-item"><a href="https://twitter.com/intent/tweet?text={{ $event->getTranslatedAttribute('title', \App::getLocale()) }}&amp;url=http://rym.uz/event/" class="footer-social-links-link"><svg width="23"
    ...
    <div class="topic">
        <div class="rym-container">
            ...
            <div class="topic-like-btn-wrap">
                <button class="topic-like-btn" type="button" data-type="event_id" data-id="{{ $event->id }}">
