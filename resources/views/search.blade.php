    ...
    <div class="search">
        <div class="rym-container">
            <div class="search-block">
                ...
                <div class="search-title">@lang('messages.welcome'):</div>
                

                @if($courses->count()>0)
                <div class="search-hudud">@lang('messages.courses')</div>
                ...
                @if($posts->count()>0)
                <div class="search-hudud">@lang('messages.posts')</div>
                ...
                @if($oavs->count()>0)
                <div class="search-hudud">@lang('messages.oav')</div>
                @foreach ($oavs as $oav)
                ...
                @if($news->count()>0)
                <div class="search-hudud">@lang('messages.news')</div>
                @foreach ($news as $new)
                ...
                @if($events->count()>0)
                <div class="search-hudud">@lang('messages.events')</div>
