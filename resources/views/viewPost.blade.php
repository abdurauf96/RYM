    ...
    <div class="topic-header-social">
        <div class="topic-header-social-left">
            ...
            <div class="topic-header-social-left-item">
                ...
                <span class="likes_post_id"> {{ $post->likes()->count() }}  </span>
            </div>
        </div>
    ...
    <div class="topic">
        <div class="rym-container">
            ...
            <div class="topic-like-btn-wrap">
                <button class="topic-like-btn "  type="button" data-type="post_id" data-id="{{ $post->id }}">
            ...
            <div class="rym-container">
                <div class="news-slider">
                    ...
                    <div class="news-slider-item">
                        ...
                        <a href="{{ route('viewPost', $other->slug ) }}" class="news-slider-link">@lang('messages.more')</a>
                    </div>
                    @endforeach
